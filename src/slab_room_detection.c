 ...
 *     A composite of the several boxes is then returned as a 2D array of 
 *     booleans, where a value of 1 represents the slabs that are in the room.
 * @par Comment:
 *     None.
 * @author   Ed Kearney
