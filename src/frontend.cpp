...
struct GuiButtonInit frontend_main_menu_buttons[] = {
  ...
  { 0,  0, 0, 0, frontend_start_new_game,NULL,frontend_over_button,     3, 999,  82, 999,  82, 371, 46, frontend_draw_large_menu_button,  0, GUIStr_Empty,  0,       {2},            0, NULL },
  { 0,  0, 0, 0, frontend_load_continue_game,NULL,frontend_over_button, 0, 999, 124, 999, 124, 371, 46, frontend_draw_large_menu_button,  0, GUIStr_Empty,  0,       {8},            0, frontend_continue_game_maintain },
  { 0,  0, 0, 0, frontend_ldcampaign_change_state,NULL,frontend_over_button,30,999,166,999,166,371, 46, frontend_draw_large_menu_button,  0, GUIStr_Empty,  0,     {112},            0, NULL },
  { 0,  0, 0, 0, frontend_change_state,NULL, frontend_over_button,   34, 999, 208,   999, 208, 371, 46, frontend_draw_large_menu_button,  0, GUIStr_Empty,  0,      {106},            0, NULL },
  { 0,  0, 0, 0, frontend_change_state,NULL, frontend_over_button,    2, 999, 250,   999, 250, 371, 46, frontend_draw_large_menu_button,  0, GUIStr_Empty,  0,       {3},            0, frontend_main_menu_load_game_maintain },
  { 0,  0, 0, 0, frontend_netservice_change_state,NULL, frontend_over_button,4,999,292,999,292,371, 46, frontend_draw_large_menu_button,  0, GUIStr_Empty,  0,       {4},            0, frontend_main_menu_netservice_maintain },
  { 0,  0, 0, 0, frontend_change_state,NULL, frontend_over_button,   27, 999, 334,   999, 334, 371, 46, frontend_draw_large_menu_button,  0, GUIStr_Empty,  0,      {97},            0, NULL },
  { 0,  0, 0, 0, frontend_ldcampaign_change_state,NULL, frontend_over_button,18,999,376,999,376,371,46, frontend_draw_large_menu_button,  0, GUIStr_Empty,  0,     {104},            0, frontend_main_menu_highscores_maintain },
  { 0,  0, 0, 0, frontend_change_state,NULL, frontend_over_button,      9, 999, 418, 999, 418, 371, 46, frontend_draw_large_menu_button,  0, GUIStr_Empty,  0,       {5},            0, NULL },
